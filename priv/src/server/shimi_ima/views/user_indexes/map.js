function map(doc) {
  ...
  */
  ...
  if (doc.category === "index") {
    ...
    retval = makeObj(userIndexMap.toString().replace(/doc\.\$doctype\$/, doc.doctype));
    retval = retval.replace(/doc\.\$show_deleted\$/, doc.show_deleted.toString());
    retval = retval.replace(/doc\.\$expression\$/, doc.expression);
    retval = retval.replace(/doc\.\$fields\$/, doc.fields);
    retval = retval.replace(/doc\.\$replace_function_exists\$/, (doc.replace_function !== undefined).toString());
    retval = retval.replace(/doc\.\$replace_function\$/, doc.replace_function.toString());
