...
exports.toLocaleFormat = function () {
  'use strict';
  if (!Date.toLocaleFormat) {
    ...
    Date.prototype.toLocaleFormat = function (formatString) {
      ...
      return formatString.replace(Date.prototype.toLocaleFormat.re, function (match, code, position, str) {
        if (match === '%%') {
          ...
          return Date.prototype.toLocaleFormat[code](self);
        }
      });
    };
     ...
     */
    Date.prototype.toLocaleFormat.b = Date.prototype.toLocaleFormat.h = function (d) {
     ...
     */
    Date.prototype.toLocaleFormat.C = function (d) {
      return d.getFullYear().toString().substr(0, 2);
    };
    /**
    ...
    Date.prototype.toLocaleFormat.s = function (d) {
      return parseInt(d.getTime() / 1000, 10).toString();
    };
    /**
