          ...
          [
           {'_', 
            [
             ...
             {"/projects/:project/indexes/:id/view", index_resource, [{target, view}|Opts]},
             ...
             {"/projects/:project/config/doctypes/:id/touch", config_doctype_resource, [{target, touch}|Opts]},
             ...
             {"/projects/:project/config/doctypes/:doctype/fieldsets/:fieldset/fields/:id", config_field_resource, [{target, identifier}|Opts]},
             ...
             {"/projects/:project/doctypes/:doctype/fieldsets/:fieldset/fields/:id", field_resource, [{target, identifier}|Opts]},
