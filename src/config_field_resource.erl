...
%%% @doc The resource used accessing and editing fields in a configuration
%%%     context.

-module(config_field_resource).
-author('Noah Diewald <noah@diewald.me>').
...
index_html(R, S) ->
    ...
    Html = render:renderings([{<<"rows">>, Fields}], config_field_list_elements_dtl),
    {Html, R1, S}.
