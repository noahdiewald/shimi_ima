...
index_info2() ->
    ...
    I = {<<"index">>, [{<<"1">>, [null,true]},
                       ...
                       {<<"4">>, [[null,<<"four">>],
                                  [null,<<"six">>]]}]},
    lists:reverse([R, H, C, I|lists:reverse(document_json2())]).
...
index_info4() ->
    ...
    I = {<<"index">>, [{<<"1">>, [null,<<"one">>]},
                       ...
                       {<<"6">>, [[null,<<"six">>],
                                  [null,<<"ten">>]]}]},
    lists:reverse([R, H, C, I|lists:reverse(document_json4())]).
...
index_info2by4() ->
    ...
    I = {<<"index">>, [{<<"1">>, [null,<<"one">>]},
                       ...
                       {<<"4">>, [[null,<<"four">>],
                                  ...
                                  [null,<<"eight">>],
                                  [null,<<"ten">>]]}]},
    lists:reverse([R, H, C, I|lists:reverse(document_json2by4())]).
...
document_json4() ->
    ...
    [_,_,_,_,_|Doc] = lists:reverse(document_json()),
    ...
    {"Conversion from a record to a JSON term",
     [
      ...
      {"Whole four two field multifieldset document",
       ?_assertEqual(index_info2by4(), document:to_json(doc, document2by4()))},
      {"Heads of four two field multifieldset document",
       ?_assertEqual(jsn:get_value(<<"head">>, index_info2by4()),
                     jsn:get_value(<<"head">>, 
                                   document:to_json(doc, document2by4())))},
...
normalize_test_() ->
    {"Normalization tests",
      [
       {"Simple document",
        ?_assertEqual(document_json(), document:normalize(doc, document_json()))},
       {"Two two field multifieldsets",
        ?_assertEqual(index_info2(), document:normalize(doc, index_info2()))},
       {"Two four field multifieldsets",
        ?_assertEqual(index_info4(), document:normalize(doc, index_info4()))},
       {"Four two field multifieldsets",
        ?_assertEqual(index_info2by4(),document:normalize(doc, index_info2by4()))}
      ]}.
